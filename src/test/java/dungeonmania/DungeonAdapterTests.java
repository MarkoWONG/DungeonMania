...
public class DungeonAdapterTests {
    ...
    public void testDungeonName() {
        Dungeon currDungeon = new Dungeon("dungeon_static","Standard", System.currentTimeMillis());
    ...
    public void testItemResponse() {
        Dungeon currDungeon = new Dungeon("dungeon_collectable","Standard", System.currentTimeMillis());
    ...
    public void testBuildableContents() {
        Dungeon currDungeon = new Dungeon("buildableEntities","Standard", System.currentTimeMillis());
    ...
    public void testGoalContents() {
        Dungeon currDungeon = new Dungeon("advanced","Standard", System.currentTimeMillis());
        DungeonResponseAdapter adapter = new DungeonResponseAdapter(currDungeon);
        DungeonResponse currResponse = adapter.createDungResponse();
